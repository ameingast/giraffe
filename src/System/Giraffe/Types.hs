...
data ScrapeResponse = ScrapeResponse
    ...
    , scrapeResponseFailure :: Maybe Text
...
instance BEEncodable InvalidResponse where
    encode (InvalidResponse msg) = Just $ (BString . BS.fromChunks) [encodeUtf8 msg]
